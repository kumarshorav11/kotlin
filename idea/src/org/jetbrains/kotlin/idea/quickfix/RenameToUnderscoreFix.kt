    ...
    companion object Factory : KotlinSingleIntentionActionFactory() {
        override fun createAction(diagnostic: Diagnostic): IntentionAction? {
            val declaration: KtCallableDeclaration? = when (diagnostic.factory) {
                ...
                Errors.UNUSED_VARIABLE, Errors.ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE ->
                    diagnostic.psiElement as? KtDestructuringDeclarationEntry
                Errors.UNUSED_DESTRUCTURED_PARAMETER_ENTRY -> diagnostic.psiElement as? KtDestructuringDeclarationEntry
                else -> null
            }
