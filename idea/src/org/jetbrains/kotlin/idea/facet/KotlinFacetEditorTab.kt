...
class KotlinFacetEditorTab(
    ...
    private fun getDefaultTargetPlatform(): KotlinFacetConfiguration.TargetPlatform {
        getRuntimeLibraryVersions { getLibraryProperties(JavaRuntimePresentationProvider.getInstance(), this) }.firstOrNull()?.let { javaLib ->
            return KotlinFacetConfiguration.TargetPlatform.JVM_1_8
        }
